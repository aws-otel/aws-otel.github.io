...
import integtestworkflow from "assets/img/blogs/testFramework/integtestworkflow.png"
import validatorexample from "assets/img/blogs/testFramework/validatorexample.png"
import validationtemplate from "assets/img/blogs/testFramework/validationtemplate.png"
import validationtype from "assets/img/blogs/testFramework/validationtype.png"
import yamlfile from "assets/img/blogs/testFramework/yamlfile.png"
import result from "assets/img/blogs/testFramework/result.png"
import vasivasireddy from "assets/img/blogs/testFramework/vasivasireddy.png"
import richardto from "assets/img/blogs/testFramework/richardto.png"
...
3. Running one of the test cases:
    ```
    cd aws-otel-test-framework/terraform/mock
        ...
        terraform destroy
     ```
4. What does the running the test case with this method execute?
...
2. Run the following commands to automatically create the necessary resources in your AWS account
...
6. Don’t forget to clean up your resources after running the tests.
...
2. Setup your expected test results in the following path:` resources/expected-data-template/ `

  * Create a JSON template using the schema - ["http://json-schema.org/draft-04/schema#"]("http://json-schema.org/draft-04/schema#")
  * Create a .mustache file using the schema - ["https://mustache.github.io/"](https://mustache.github.io/)

Based on the dimensions and the metrics generated by the processors, we have created an expected JSON template Pod.json file that generates the expected output in the Test Framework, located at the following path:` validator/src/main/resources/expected-data-template/container-insight/eks/fargate/Pod.json `
