---
title: 'AWS Distro for OpenTelemetry Lambda Layers that contains ADOT Collector v0.43.0 are now available'
description:
    May 2025 release announcement for ADOT Lambda layers
---
