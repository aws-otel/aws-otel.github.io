---
title: "AWS Distro for OpenTelemetry Java Instrumentation 2.0.1"
description: This blog post is the release announcement for AWS Distro for OpenTelemetry - Instrumentation for Java 2.0.1
---
...
[AWS Distro for OpenTelemetry (ADOT)](https://aws-otel.github.io/) Agent for Java 2.0.1 is now available.
...
[GitHub](https://github.com/aws-observability/aws-otel-java-instrumentation/releases/tag/v2.0.1) and [Maven Central Repository](https://central.sonatype.com/artifact/software.amazon.opentelemetry/aws-opentelemetry-agent/2.0.1).
