---
title: 'AWS Distro for OpenTelemetry v0.43.2'
description:
    This blog post is the release announcement for ADOT Collector v0.43.2
---
...
[AWS Distro for OpenTelemetry (ADOT)](https://aws-otel.github.io/) Collector v0.43.2 is now available.
...
* Wrap environment variable substitution syntax in quotes under prometheus configuration
