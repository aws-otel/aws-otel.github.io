---
title: 'AWS Distro for OpenTelemetry v0.47.0'
description:
    This blog post is the release announcement for ADOT Collector v0.47.0
---
...
[AWS Distro for OpenTelemetry (ADOT)](https://aws-otel.github.io/) Collector v0.47.0 is now available.
...
* Bump OpenTelemetry Collector and Collector contrib dependencies to `v0.143.0`
...
[GitHub](https://github.com/aws-observability/aws-otel-collector/releases/tag/v0.47.0).
