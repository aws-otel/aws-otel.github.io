---
title: "AWS Distro for OpenTelemetry Java Instrumentation 1.33.0"
description: This blog post is the release announcement for AWS Distro for OpenTelemetry - Instrumentation for Java 1.33.0
---
...
[AWS Distro for OpenTelemetry (ADOT)](https://aws-otel.github.io/) Agent for Java 1.33.0 is now available.
...
[GitHub](https://github.com/aws-observability/aws-otel-java-instrumentation/releases/tag/v1.33.0) and [Maven Central Repository](https://central.sonatype.com/artifact/software.amazon.opentelemetry/aws-opentelemetry-agent/1.33.0).
