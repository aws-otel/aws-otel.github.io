---
title: 'AWS Distro for OpenTelemetry EKS add-on v0.102.1'
description:
    This blog post is the release announcement for ADOT EKS Add-on v0.102.1
---
...
[AWS Distro for OpenTelemetry (ADOT)](https://aws-otel.github.io/) EKS Add-on v0.102.1 is now available.

<SectionSeparator />

**Release Highlights**

* ADOT Collector [v0.40.2](https://github.com/aws-observability/aws-otel-collector/releases/tag/v0.40.2)
* Upgrades to Go version 1.22.7 to address security risk [CVE-2024-34156]
