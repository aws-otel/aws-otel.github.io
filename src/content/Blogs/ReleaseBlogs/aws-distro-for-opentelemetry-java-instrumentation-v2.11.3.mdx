---
title: "AWS Distro for OpenTelemetry Java Instrumentation 2.11.3"
description: This blog post is the release announcement for AWS Distro for OpenTelemetry - Instrumentation for Java 2.11.3
---
...
[AWS Distro for OpenTelemetry (ADOT)](https://aws-otel.github.io/) Agent for Java 2.11.3 is now available.

<SectionSeparator />

**Release Highlights**

Removes previous patching mechanism and integrates the Service Provider Interface (SPI) to extend functionality of OpenTelemetry Instrumentation for Java - [2.11.0](https://github.com/open-telemetry/opentelemetry-java-instrumentation/releases/tag/v2.11.0)
...
[GitHub](https://github.com/aws-observability/aws-otel-java-instrumentation/releases/tag/v2.11.3) and [Maven Central Repository](https://central.sonatype.com/artifact/software.amazon.opentelemetry/aws-opentelemetry-agent/2.11.3).
