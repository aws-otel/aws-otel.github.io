---
title: 'AWS Distro for OpenTelemetry v0.49.0'
description:
    This blog post is the release announcement for ADOT Collector v0.49.0
---
...
[AWS Distro for OpenTelemetry (ADOT)](https://aws-otel.github.io/) Collector v0.49.0 is now available.
...
* Bump OpenTelemetry Collector and Collector Contrib dependencies to `v0.156.0`
* Upgrade Go from 1.26.2 to 1.26.4
* Update `golang.org/x` and `apache/thrift` dependencies
...
[GitHub](https://github.com/aws-observability/aws-otel-collector/releases/tag/v0.49.0).
