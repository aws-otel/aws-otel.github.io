---
title: "AWS Distro for OpenTelemetry Java Instrumentation 2.11.5"
description: This blog post is the release announcement for AWS Distro for OpenTelemetry - Instrumentation for Java 2.11.5
---
...
[AWS Distro for OpenTelemetry (ADOT)](https://aws-otel.github.io/) Agent for Java 2.11.5 is now available.
...
[GitHub](https://github.com/aws-observability/aws-otel-java-instrumentation/releases/tag/v2.11.5) and [Maven Central Repository](https://central.sonatype.com/artifact/software.amazon.opentelemetry/aws-opentelemetry-agent/2.11.5).
