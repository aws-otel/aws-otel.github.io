---
title: 'AWS Distro for OpenTelemetry v0.43.0'
description:
    This blog post is the release announcement for ADOT Collector v0.43.0
---
...
[AWS Distro for OpenTelemetry (ADOT)](https://aws-otel.github.io/) Collector v0.43.0 is now available.
...
* Updated OpenTelemetry Collector dependencies to `v0.117.0`
* Updated OpenTelemetry Collector contrib dependencies to `v0.117.0`
...
[GitHub](https://github.com/aws-observability/aws-otel-collector/releases/tag/v0.43.0).
