---
title: 'AWS Distro for OpenTelemetry EKS add-on v0.131.0-eksbuild1'
description:
    This blog post is the release announcement for ADOT EKS Add-on v0.131.0-eksbuild1
---
...
[AWS Distro for OpenTelemetry (ADOT)](https://aws-otel.github.io/) EKS Add-on v0.131.0-eksbuild1 is now available.

<SectionSeparator />

**Release Highlights**

* ADOT Collector [v0.45.0](https://github.com/aws-observability/aws-otel-collector/releases/tag/v0.45.0)
* Support for EKS 1.33
* Use ADOT Operator ECR Image - `0.131.0`
