---
title: 'AWS Distro for OpenTelemetry v0.41.2'
description:
    This blog post is the release announcement for ADOT Collector v0.41.2
---
...
[AWS Distro for OpenTelemetry (ADOT)](https://aws-otel.github.io/) Collector v0.41.2 is now available.
...
* Bump golang.org/x/net and crypto dependencies to the recommended versions.
...
[GitHub](https://github.com/aws-observability/aws-otel-collector/releases/tag/v0.41.2).
