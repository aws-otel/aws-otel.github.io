---
title: 'AWS Distro for OpenTelemetry v0.37.1'
description:
    This blog post is the release announcement for ADOT Collector v0.37.1
---
...
[AWS Distro for OpenTelemetry (ADOT)](https://aws-otel.github.io/) Collector v0.37.1 is now available.
...
[GitHub](https://github.com/aws-observability/aws-otel-collector/releases/tag/v0.37.1).
