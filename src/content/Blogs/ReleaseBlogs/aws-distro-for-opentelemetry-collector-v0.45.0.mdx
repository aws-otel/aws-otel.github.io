---
title: 'AWS Distro for OpenTelemetry v0.45.0'
description:
    This blog post is the release announcement for ADOT Collector v0.45.0
---
...
[AWS Distro for OpenTelemetry (ADOT)](https://aws-otel.github.io/) Collector v0.45.0 is now available.
...
* Updated OpenTelemetry Collector dependencies to `v0.131.0`
* Updated OpenTelemetry Collector contrib dependencies to `v0.131.0`
...
[GitHub](https://github.com/aws-observability/aws-otel-collector/releases/tag/v0.45.0).
...
[Roy Chiang](https://github.com/roystchiang) is a SDE on the AWS Open-Source Observability team.
