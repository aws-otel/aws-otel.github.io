---
title: "AWS Distro for OpenTelemetry Collector v0.38.1 and v0.37.2"
description: This blog post is the release announcement for ADOT Collector v0.38.1 and v0.37.2
---
...
[AWS Distro for OpenTelemetry (ADOT)](https://aws-otel.github.io/) Collector v0.38.1 and v0.37.2 now available.
...
We are aware of a potential issue in the Go standard library prior to version 1.22.1, used by the AWS Distribution for OpenTelemetry (ADOT) Collector up to and including v0.38.0 and also v0.37.1.
We have prepared two new releases of the ADOT Collector, v0.38.1 and v0.37.2 using Go 1.22.1. There are no functional changes from the previous patch versions. We recommend that customers update their
ADOT Collector to at least v0.38.1 or v0.37.2 at the earliest opportunity. See https://aws-otel.github.io/docs/getting-started/collector for information on deploying the ADOT Collector.

Reference: https://groups.google.com/g/golang-announce/c/5pwGVUPoMbg

We are aware of a potential issue in the `google.golang.org/protobuf` module prior to version 1.33.0, used by the AWS Distribution for OpenTelemetry (ADOT) Collector up to and including v0.38.0 and also v0.37.1.
We have prepared two new releases of the ADOT Collector, v0.38.1 and v0.37.2 using `google.golang.org/protobuf@v1.33.0`. There are no functional changes from the previous patch versions. We recommend that customers update their
ADOT Collector to at least v0.38.1 or v0.37.2 at the earliest opportunity. See https://aws-otel.github.io/docs/getting-started/collector for information on deploying the ADOT Collector.

Reference: https://nvd.nist.gov/vuln/detail/CVE-2024-24786

**Release Highlights**

- Recompile with Go 1.22.1 to mitigate CVE-2024-24783, CVE-2023-45290, CVE-2023-45289, and CVE-2024-24785
- Update `google.golang.org/protobuf` to v1.33.0 to mitigate CVE-2024-24786
...
[GitHub](https://github.com/aws-observability/aws-otel-collector/releases/tag/v0.38.1).
