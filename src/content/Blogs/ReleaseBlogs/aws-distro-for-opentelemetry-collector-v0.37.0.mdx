---
title: 'AWS Distro for OpenTelemetry v0.37.0'
description:
    This blog post is the release announcement for ADOT Collector v0.37.0
---
...
[AWS Distro for OpenTelemetry (ADOT)](https://aws-otel.github.io/) Collector v0.37.0 is now available.
...
* [OpenTelemetry Collector Contrib v0.91.0](https://github.com/open-telemetry/opentelemetry-collector-contrib/releases/tag/v0.91.0)
* [OpenTelemetry Collector Contrib v0.92.0](https://github.com/open-telemetry/opentelemetry-collector-contrib/releases/tag/v0.92.0)
...
- **Patch** [opentelemetry-collector-contrib/exporter/prometheusremotewrite] Fix: Validate context is canceled during retries [#30308](https://github.com/open-telemetry/opentelemetry-collector-contrib/pull/30308)
