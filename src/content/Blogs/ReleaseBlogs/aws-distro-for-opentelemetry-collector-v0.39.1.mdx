---
title: 'AWS Distro for OpenTelemetry v0.39.1'
description:
    This blog post is the release announcement for ADOT Collector v0.39.1
---
...
[AWS Distro for OpenTelemetry (ADOT)](https://aws-otel.github.io/) Collector v0.39.1 is now available.
...
**Release Highlights**
* Changes from `go.opentelemetry.io/collector/config/configgrpc` and `go.opentelemetry.io/collector/config/confighttp` to address a [security advisory](https://github.com/advisories/GHSA-c74f-6mfw-mm4v) have been backported.
...
[GitHub](https://github.com/aws-observability/aws-otel-collector/releases/tag/v0.39.1).
