---
title: 'AWS Distro for OpenTelemetry EKS add-on v0.90.0'
description:
    This blog post is the release announcement for ADOT EKS Add-on v0.90.0
---
...
[AWS Distro for OpenTelemetry (ADOT)](https://aws-otel.github.io/) EKS Add-on v0.90.0 is now available.

<SectionSeparator />

**Release Highlights**

* ADOT Collector [v0.36.0](https://github.com/aws-observability/aws-otel-collector/releases/tag/v0.36.0)
* ADOT autoinstrumentation java [v1.32.0](https://github.com/aws-observability/aws-otel-java-instrumentation/releases/tag/v1.32.0)
