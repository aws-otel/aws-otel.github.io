...
* Users of the `datadog`, `logzio`, `sapm`, `signalfx` exporter components, the following components in the ADOT Collector are behind a feature gate and is disabled by default. Please refer to [Attention: ADOT Collector v0.41.0 breaking changes - third party exporters deprecation](https://github.com/aws-observability/aws-otel-collector/issues/2734)
