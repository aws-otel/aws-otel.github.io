---
title: 'AWS Distro for OpenTelemetry EKS add-on v0.151.0-eksbuild.1'
description:
    This blog post is the release announcement for ADOT EKS Add-on v0.151.0-eksbuild.1
---
...
[AWS Distro for OpenTelemetry (ADOT)](https://aws-otel.github.io/) EKS Add-on v0.151.0-eksbuild.1 is now available.
