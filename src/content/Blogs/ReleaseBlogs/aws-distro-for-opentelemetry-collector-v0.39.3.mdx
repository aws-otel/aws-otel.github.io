---
title: 'AWS Distro for OpenTelemetry v0.39.3'
description:
    This blog post is the release announcement for ADOT Collector v0.39.3
---
...
[AWS Distro for OpenTelemetry (ADOT)](https://aws-otel.github.io/) Collector v0.39.3 is now available.
...
**Release Highlights**
* Upgrades to Go version 1.22.7 to address security risk
* Upgrades to go-grpc-compression 1.2.3 to address security risk
...
[GitHub](https://github.com/aws-observability/aws-otel-collector/releases/tag/v0.39.3).
