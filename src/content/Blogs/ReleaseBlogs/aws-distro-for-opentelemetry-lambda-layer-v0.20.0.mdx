...
- Collector layer **aws-otel-collector-<amd64|arm64>-ver-0-56-0** contains ADOT Collector for Lambda `v0.18.0`. Compatible with [.NET](https://aws-otel.github.io/docs/getting-started/lambda/lambda-dotnet) and [Go](https://aws-otel.github.io/docs/getting-started/lambda/lambda-go) runtimes.
