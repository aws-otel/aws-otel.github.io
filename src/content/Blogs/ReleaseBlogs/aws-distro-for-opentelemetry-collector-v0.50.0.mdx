---
title: 'AWS Distro for OpenTelemetry v0.50.0'
description:
    This blog post is the release announcement for ADOT Collector v0.50.0
---
...
[AWS Distro for OpenTelemetry (ADOT)](https://aws-otel.github.io/) Collector v0.50.0 is now available.
...
* Bump OpenTelemetry Collector and Collector Contrib dependencies to `v0.158.0`
* Note: the upstream `filter` processor default `error_mode` is now permanently `ignore`; see the
[release notes](https://github.com/aws-observability/aws-otel-collector/releases/tag/v0.50.0) for details
...
[GitHub](https://github.com/aws-observability/aws-otel-collector/releases/tag/v0.50.0).
