---
title: 'AWS Distro for OpenTelemetry v0.43.1'
description:
    This blog post is the release announcement for ADOT Collector v0.43.1
---
...
[AWS Distro for OpenTelemetry (ADOT)](https://aws-otel.github.io/) Collector v0.43.1 is now available.
...
* Bump expr-lang/expr dependency to 1.17.0.
