...
[AWS Distro for OpenTelemetry (ADOT)](https://aws-otel.github.io/) Agent for Java 2.11.0 is now available.

<SectionSeparator />

**Release Highlights**

Contains the patched version of OpenTelemetry Instrumentation for Java - [2.11.1](https://github.com/open-telemetry/opentelemetry-java-instrumentation/releases/tag/v2.11.1)

Check out the release notes for upstream version
 - https://github.com/open-telemetry/opentelemetry-java-instrumentation/releases/tag/v2.11.1
