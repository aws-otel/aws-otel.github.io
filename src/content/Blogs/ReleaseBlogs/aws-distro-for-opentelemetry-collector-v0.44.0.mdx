---
title: 'AWS Distro for OpenTelemetry v0.44.0'
description:
    This blog post is the release announcement for ADOT Collector v0.44.0
---
...
[AWS Distro for OpenTelemetry (ADOT)](https://aws-otel.github.io/) Collector v0.44.0 is now available.
...
* Updated OpenTelemetry Collector dependencies to `v0.130.0`
* Updated OpenTelemetry Collector contrib dependencies to `v0.130.0`
* Backport fix for awscontainerinsightreceiver [\#3090](https://github.com/aws-observability/aws-otel-collector/pull/3090)
