...
We are aware of a potential issue in the Go standard library prior to version 1.18.6 [CVE-2022-27664](https://nvd.nist.gov/vuln/detail/CVE-2022-27664) used by 
the AWS Distribution for Open Telemetry (ADOT) Collector prior to version 0.20.1.

We have prepared a new release of the ADOT Collector, 0.20.1 using Go 1.18.6. There are no functional changes from ADOT Collector v0.20.0. 
We recommend that customers update their ADOT Collector to at least v0.20.1 at the earliest opportunity. 
See [here](https://aws-otel.github.io/docs/getting-started/collector) for information on deploying the ADOT Collector.
Reference: [https://nvd.nist.gov/vuln/detail/CVE-2022-27664](https://nvd.nist.gov/vuln/detail/CVE-2022-27664)
