...
Use AWS Distro for OpenTelemetry to instrument your applications running on
...
* Use AWS Distro for OpenTelemetry to **observe your applications** running on Amazon Elastic Compute Cloud (EC2), Amazon
