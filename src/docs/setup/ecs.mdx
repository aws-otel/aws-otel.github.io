...
In this tutorial, we will demonstrate how to run AWS Distro for OpenTelemetry Collector (AWS Otel Collector) as a
sidecar on the Amazon Elastic Container Service (Amazon ECS) in Fargate and in Amazon Elastic Compute Cloud
(Amazon EC2) mode. We provide a sample application within the same Amazon ECS task to send trace data to AWS
OTel Collector.
...
1. **Setup the AWS OTel Collector**<br/>
    ...
    * ***[Option-1] Setup using CloudFormation template***<br/>
        ...
        who are new to ECS.
        - <Link to="/docs/setup/ecs/create-cluster">Deploy AOT for ECS on EC2</Link>
        - <Link to="/docs/setup/ecs/create-cluster">Deploy AOT for ECS on Fargate</Link> 
    * ***[Option-2] Setup using ECS Task Definition***<br/>
        ...
        1. **Create Task Definition**
            * <Link to="/docs/setup/ecs/create-cluster">Create task definition for ECS on EC2</Link>  
            * <Link to="/docs/setup/ecs/create-cluster">Create task definition for ECS on Fargate</Link>  
        1. <Link to="/docs/setup/ecs/create-cluster">Deploy Task</Link>  
    * ***[Option-3] Setup using AWS Management Console***<br/>
        ...
        1. <Link to="/docs/setup/ecs/create-iam-policy">Create IAM Policy</Link> 
        1. <Link to="/docs/setup/ecs/create-iam-role">Create IAM Role</Link> 
        1. <Link to="/docs/setup/ecs/create-cluster">Create Task Definition using AWS Console</Link> 
        1. <Link to="/docs/setup/ecs/create-cluster">Run Task</Link>  
1. **Results**<br/>
...
1. <Link to="/docs/setup/ecs/create-cluster">Use custom OpenTelemetry configuration file using SSM Parameter</Link> 
1. **Reference**<br/>
