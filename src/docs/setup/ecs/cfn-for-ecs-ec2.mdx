...
If you are not famaliar with how to create a cluster, See the <Link to="/docs/setup/ecs/create-cluster">create-cluster</Link>
section to learn how to create a cluster.
