...
of AOC is passive, if your application doesn’t emit the data to the port (X-ray use UDP 2000 and OPTL use TCP 55680 and 55681) then there will be no effect.
...
10. Let’s add a sample application container in similar way (you can configure your application like this)
    ...
    * 10.4  In the ENVIRONMENT part, cancel the check checkmark .
       <img src={task21} alt="Diagram" style="margin: 30px 0;" />
    * 10.5  Keep the rest information as default and click add.
