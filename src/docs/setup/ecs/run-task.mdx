...
If you selected he EC2 as your launch Type when you are creating your task,you can just select EC2 as your Launch type,
select the cluster you want to use and click the run task button.
3. You can go to the cluster to see the task running. And you can check your <Link to="/docs/setup/ecs/Results">Result</Link>.