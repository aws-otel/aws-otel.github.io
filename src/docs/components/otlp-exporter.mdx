...
In this section, we will getting started configurations to the Collector to export telemetry data to **AppDynamics, Honeycomb, Lightstep, and SumoLogic** end-points.
...
See [Ingest OpenTelemetry Trace Data](https://docs.appdynamics.com/display/PRMY21/.Ingest+OpenTelemetry+Trace+Data)
