...
* Select the “EKS_Cluster, EKS_Namespace, EKS_PodName“ to view your metrics data
  * For example, if you replaced `<YOUR-APPLICATION-METRIC>` with `scrape_duration_seconds`, you would see this here
