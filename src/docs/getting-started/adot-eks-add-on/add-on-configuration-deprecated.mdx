...
> **IMPORTANT**: The following documentation is for ADOT EKS add-on versions less than `v0.88.0-eksbuild.1`.  If you are using a version greater than or equal to `v0.88.0-eksbuild.1`, 
