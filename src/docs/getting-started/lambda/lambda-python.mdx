...
|---------------------|-------------------------|----------|
| ap-northeast-1<br/>ap-northeast-2<br/>ap-south-1<br/>ap-southeast-1<br/>ap-southeast-2<br/>ca-central-1<br/>eu-central-1<br/>eu-north-1<br/>eu-west-1<br/>eu-west-2<br/>eu-west-3<br/>sa-east-1<br/>us-east-1<br/>us-east-2<br/>us-west-1<br/>us-west-2 | arn:aws:lambda:<region\>:901920570463:layer:aws-otel-python-<architecture\>-ver-1-18-0:2 | Contains [OpenTelemetry Python v1.18.0](https://github.com/open-telemetry/opentelemetry-python/releases/tag/v1.18.0) <br/><br/> Contains ADOT Collector v0.30.0 |
