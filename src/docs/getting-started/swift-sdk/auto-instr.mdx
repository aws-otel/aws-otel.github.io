...
ADOT Swift is pre-configured to work out of the box with AWS CloudWatch RUM. To export RUM telemetry to CloudWatch RUM, you will need to first [create an app monitor](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-RUM-get-started-create-app-monitor.html), ideally with resource-based policies. Next, add `aws_config.json` to your application bundle:
