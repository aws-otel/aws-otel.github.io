---
title: 'Getting started sending CloudWatch Metrics with AWS OpenTelemetry'
description:
    ...
    application metrics which is well supported by EMF. In this tutorial, we will walk through how to enable CloudWatch metrics in AWS OTel Collector.
path: '/docs/getting-started/cloudwatch-metrics'
---

import { Link } from "gatsby"
import SectionSeparator from "components/MdxSectionSeparator/sectionSeparator.jsx"
import img3 from "assets/img/docs/img3.png"
...
<img src={img3} alt="Diagram" style="margin: 30px 0;" />

To get started using AWS OTel Collector to send application metrics, you must first install AWS OTel Collector in your
...
**AWS Observability Collector supports CloudWatch metics with the default configuration**
AWS OTel Collector provides a default configuration out of box that enables CloudWatch metrics. The default
configuration includes the essential components for metric enabling in AWS OTel Collector.
...
This out-of-box configuration from AWS OTel Collector has supported CloudWatch metrics, but we provide more options to
...
**[AWS EMF Exporter (awsemf)](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/master/exporter/awsemfexporter)**
...
AWS OTel Collector utilizes the default log group name and namespace generated from application to support data correlation.
