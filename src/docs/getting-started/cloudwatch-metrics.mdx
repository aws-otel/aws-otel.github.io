...
Log Retention can only be set this way for newly created Cloudwatch log groups.  This feature will not update log retention for exisiting Cloudwatch log groups.
