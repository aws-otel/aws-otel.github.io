...
Configure AWS X-Ray id generator, propagator and OTLP exporter to the `TracerProvider` globally in your application as follows. Make sure to call `AddXRayTraceId()` in the very **beginning** when creating `TracerProvider`
