...
* [Manual Instrumentation on Metrics with JavaScript SDK](js-sdk/metric-manual-instr)
* [Manual Instrumentation on Traces with JavaScript SDK](js-sdk/trace-manual-instr)


## Sample Code with JavaScript SDK
* [AWS Distro for OpenTelemetry Sample Code with JavaScript SDK](https://github.com/aws-observability/aws-otel-js/tree/master/integ-test/js-sdk-emitter)
