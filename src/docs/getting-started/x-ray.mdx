...
| aws_log_groups                                                                | cloudwatch_logs        | <ul><li> The CloudWatch Log Group names. This field is given a lower priority compared to the related resource attributes. </li></ul>|
