...
##### For Gradle:
```java
implementation 'io.opentelemetry.instrumentation:opentelemetry-otlp-exporter-starter:1.1.0-alpha'
```
...
##### For Gradle:
```java
implementation 'io.opentelemetry.instrumentation:opentelemetry-aws-sdk-2.2:1.1.0-alpha'
```
...
```java
implementation 'io.opentelemetry:opentelemetry-sdk-extension-aws:1.1.0'
```
