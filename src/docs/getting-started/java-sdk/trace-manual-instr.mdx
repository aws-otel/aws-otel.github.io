...
dependencies {
    implementation('io.opentelemetry:opentelemetry-sdk:0.14.1')
}
```
...
##### For Gradle:
```java
implementation 'io.opentelemetry.instrumentation:opentelemetry-otlp-exporter-starter:0.14.0'
```
...
##### For Gradle:
```java
implementation 'io.opentelemetry.instrumentation:opentelemetry-aws-sdk-2.2:0.14.0'
```
...
```java
implementation 'io.opentelemetry:opentelemetry-sdk-extension-aws:0.14.1'
```
