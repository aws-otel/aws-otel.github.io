...
dependencies {
    ...
    implementation("io.opentelemetry.contrib:opentelemetry-aws-xray:1.19.0")
}
```
...
```kotlin lineNumbers=true
dependencies {
    api(platform("io.opentelemetry.instrumentation:opentelemetry-instrumentation-bom-alpha:1.19.0-alpha"))
...
Up to v1.19.0 of OpenTelemetry for Java, there are few libraries and frameworks that make use of the Metrics API.
