...
* [AWS managed Lambda Layer for Java Auto Agent and ADOT Collector](/docs/getting-started/lambda/lambda-java-auto-instr)
* [AWS managed Lambda Layer for JavaScript SDK and ADOT Collector](/docs/getting-started/lambda/lambda-js)
* [AWS managed Lambda Layer for Python SDK and ADOT Collector](/docs/getting-started/lambda/lambda-python)
