...
### Collector-free Export to CloudWatch

To export telemetry data directly to CloudWatch without using the ADOT Collector, see [Collector-free Export to CloudWatch](/docs/setup/collector-free-export).
...
* **Source file path** - The absolute path of the source file where the telemetry originated
