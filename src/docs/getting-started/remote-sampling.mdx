...
|---------------------|-------------------------|
| ServiceName<br/>ServiceType<br/>URLPath<br/>Host<br/>HTTPMethod<br/>Attributes | ResourceAttributes.SERVICE_NAME<br/>ResourceAttributes.CLOUD_PLATFORM<br/>SemanticAttributes.HTTP_TARGET/SemanticAttributes.HTTP_URL<br/>SemanticAttributes.HTTP_HOST<br/>SemanticAttributes.HTTP_METHOD<br/>Attributes |
