...
[AOT with application metrics sample application](https://github.com/aws-observability/aws-otel-test-framework/blob/terraform/sample-apps/java-sdk-emitter/src/main/java/com/amazon/aocagent/MetricEmitter.java)
